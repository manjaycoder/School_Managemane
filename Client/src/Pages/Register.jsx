              ...
              <div className="relative group">
                ...
                <div className="relative">
                  <input
                    ...
                    name="fullName"
                    type="text"
                    className={`block w-full px-4 py-3 pl-11 rounded-lg border ${errors.fullName ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 group-hover:shadow-md`}
                ...
                {errors.fullName && <p className="mt-1 text-sm text-red-600 animate-fade-in">{errors.fullName}</p>}
              </div>
            ...
            <div className="relative group">
              ...
              <div className="relative">
                <input
                  ...
                  name="phone"
                  type="tel"
                  className={`block w-full px-4 py-3 pl-11 rounded-lg border ${errors.phone ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 group-hover:shadow-md`}
                  placeholder="Enter phone number"
                  value={formData.phone}
                  onChange={handleChange}
                />
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none mt-5">
                  <FaPhone className={`h-5 w-5 ${errors.phone ? 'text-red-500' : 'text-gray-400'}`} />
                </div>
              </div>
              {errors.phone && <p className="mt-1 text-sm text-red-600 animate-fade-in">{errors.phone}</p>}
            </div>
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  <input
                    ...
                    type="password"
                    className={`block w-full px-4 py-3 pl-11 rounded-lg border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 group-hover:shadow-md`}
